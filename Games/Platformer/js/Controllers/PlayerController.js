...
class PlayerController {
  ...
  HandleJump(gameTime, parent) {
    ...
    if (
      ...
      soundManager.Play("jump"); //obviously we would source and load an appropriate "jump" sound here

      //soundManager.Play("gunshot"); //used to be gunshot but was changed to jump, above.
    }
  }
